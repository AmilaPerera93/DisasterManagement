        ...
        findClosestButton.addActionListener(e -> {
            ...
            if (selectedLocationName != null) {
                ...
                if (closestCenter != null) {
                    ...
                    // Open MapboxApp to display the route
                    RequestLocation requestLocation = reliefQueue.getRequestLocationByName(selectedLocationName);
                    if (requestLocation != null) {
                        MapboxApp.displayRoute(
                                requestLocation.getLatitude(),
                                requestLocation.getLongitude(),
                                closestCenter.getLatitude(),
                                closestCenter.getLongitude()
                        );
                    }
                } else {
